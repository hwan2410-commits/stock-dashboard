...
def get_kr_afterhours(top_n: int = 10):
    ...
    """
    try:
        # KOSPI + KOSDAQ 상위 종목 코드 수집 (실패 시 폴백)
        try:
            kospi = fdr.StockListing("KOSPI").nlargest(80, "Marcap")["Code"].tolist()
        except Exception:
            kospi = [
                "005930","000660","005380","035420","000270","051910","006400",
                "035720","068270","028260","012330","055550","105560","096770",
                "003550","015760","086790","032830","018260","009150","051900",
                "017670","030200","000810","066570","034730","011170","018880",
                "047050","032640","033780","003490","010130","004020","010950",
                "011790","024110","009240","000100","271560","316140","086280",
                "011040","181710","207940","005490","042660","000720","097950",
                "003240","010140","004170","029780","000120","011200","021240",
                "002380","001800","033780","034020","015020","005440","000650",
                "004990","000230","002790","001040","001740","004000","002840",
                "004800","003670","011070","007070","002070","001740","004370",
                "005810","003830","000490","004210","000540","002860","008770",
            ]
        try:
            kosdaq = fdr.StockListing("KOSDAQ").nlargest(20, "Marcap")["Code"].tolist()
        except Exception:
            kosdaq = [
                "247540","091990","196170","357780","326030","145020","263750",
                "112040","039030","036570","035900","028300","214150","058470",
                "086900","068760","007390","041510","095340","067160",
            ]
